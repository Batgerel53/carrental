...
$query -> execute();
$msg="Машины мэдээллийг амжилттай устгалаа";
}
...
<head>
	...
	<title> автомашин түрээс | машин засах   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">машин засах</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">машины дэлгэрэнгүй мэдээлэл</div>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Та устгахыг хүсч байна уу');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
