...
$msg=" Брэнд амжилттай шинэчиллээ";
...
<head>
	...
	<title>Автомашин түрээс | Брэнд үүсгэх</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Брэнд үүсгэх</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Формууд</div>
...
?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Брэнд нэр</label>
												<div class="col-sm-8">
										...
										<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit"> Оруулах</button>
												</div>
											</div>
