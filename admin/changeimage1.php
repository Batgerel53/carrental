...
<head>
	...
	<title> Автомашин түрээс | Зураг засах 1</title>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">зураг 1 дэлгэрэнгүй</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Одоогийн зураг</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label"> Шинэ зураг оруулах 1<span style="color:red">*</span></label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="update" type="submit"> Шинэчлэх</button>
												</div>
											</div>
