...
$msg=" Мэдээлэл амжилттай шинэчиллээ";
...
<head>
	...
	<title>Автомашин түрээс | Машины мэдээлэл өөрчлөх</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"> мэдээлэл засах</h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading"> Үндсэн мэдээлэл</div>
...
<label class="col-sm-2 control-label">Машины нэр <span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">Брэнд сонгох<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Машины тойм<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Хагас өдрөөр(төгрөгөөр)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Шатахууны төрөл сонгох<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label"> Үйлдвэрлэсэн он <span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->ModelYear);?>" required>
</div>
<label class="col-sm-2 control-label">Суудлын багтаамж<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<div class="col-sm-4">
Зураг 1 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Зураг өөрчлөх 1</a>
</div>
<div class="col-sm-4">
Зураг 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Зураг өөрчлөх 2</a>
</div>
<div class="col-sm-4">
Зураг 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Зураг өөрчлөх 3</a>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Зураг 4<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Зураг өөрчлөх 4</a>
</div>
<div class="col-sm-4">
Зураг 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Зураг өөрчлөх 5</a>
<?php } ?>
</div>
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Нэмэлт тоноглол</div>
<div class="panel-body">
...
<label for="inlineCheckbox1"> Эйр кондишн </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2"> Хаалга цоожлогч </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Тоормос түгжигч систем </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Тоормос мэдрэгч </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> суудал халаагч </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2"> Жолоочийн аюулгүйн дэр</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Зорчигчийн аюулгүйн дэр </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Цонх буулгагч </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> CD Тоглуулагч </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2"> төв цоожлогч</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> Осол мэдрэгч </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Арьсан суудал </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
