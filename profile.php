...
$query->execute();
$msg="Профайл амжилттай шинэчиллээ";
}
...
<title>Автомашин түрээс | Миний профайл</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline"> Ерөнхий тохиргоо</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>Амжилттай</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <?php } ?>
            <div class="form-group">
              <label class="control-label">Бүтэн нэр</label>
            ...
            <div class="form-group">
              <label class="control-label">Email хаяг</label>
            ...
            <div class="form-group">
              <label class="control-label">Төрсөн он сар&nbsp;(dd/mm/yyyy)</label>
            ...
            <div class="form-group">
              <label class="control-label">Таны хаяг</label>
            ...
            <div class="form-group">
              <label class="control-label">аймаг</label>
              <input class="form-control white_bg" id="city" name="city" value="<?php echo htmlentities($result->City);?>" type="text">
            </div>
            <?php }} ?>
           
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn"> Өөрчлөлтийг хадгалах <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
