...
<title>Автомашин түрээсий систем </title>
<!--Bootstrap -->
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">шинэ машин</a></li>
        </ul>
      </div>
...
<span class="price">₮<?php echo htmlentities($result->PricePerDay);?> /Өдрөөр</span> 
</div>
